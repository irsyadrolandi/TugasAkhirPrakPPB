...
import com.example.kelar2.fragment.FragmentFavorite;
import com.example.kelar2.fragment.FragmentMovie;
import com.example.kelar2.fragment.FragmentTV;
import com.example.kelar2.utils.BottomBarBehavior;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgOrang = findViewById(R.id.imgOrang);
        imgOrang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
